...
export default function CamerasPage() {
  ...
  const handleCanvasMouseDown = (e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    // Find if user clicked near a point (within 20px radius)
  ...
  useEffect(() => {
    ...
    // Draw points with larger size for easier dragging
  ...
  useEffect(() => {
    if (editingFence) {
      ...
      if (fence && fence.points) {
        // Load the saved points from cameras.json
        setTempPoints([...fence.points])
      }
    } else {
      setTempPoints([])
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() => {
                        console.log("[v0] Settings button clicked for camera:", camera.id)
                          ...
                          <Card key={fenceIndex} className="p-4 bg-muted/50">
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-3 gap-2">
                                {availableDetectionObjects.map((obj) => (
