...
export interface CameraConfig {
  ...
  modelID?: string // Model name from models.json
}
  ...
  cameras: [
    {
      ...
      modelID: "model1", // Model name from models.json
    },
    {
      id: "cam2",
      name: "Backyard",
      ...
      modelID: "model2", // Model name from models.json
    },
    {
      id: "cam3",
      name: "Garage",
      ...
      modelID: "model3", // Model name from models.json
    },
    {
      id: "cam4",
      name: "Side Entrance",
      ...
      motionDetection: true,
      minConfidence: 70,
      modelID: "model4", // Model name from models.json
    },
  ],
  storage: {
    retentionDays: 7,
